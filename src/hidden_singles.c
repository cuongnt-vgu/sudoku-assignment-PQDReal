                    ...
                    if (p_board->p_rows[i][j]->candidates[c] == 1)
                    {
                        ...
                        if (isHiddenSingle)
                        {
                            ...
                            for (int a = 0; a < unit_size; a++)
                            {
                                ...
                                {
                                    if (p_board->p_rows[i][a]->candidates[m] == 1 && m == c && p_board->p_rows[i][a]->num_candidates >= 2)
                                    {
                            ...
                            for (int b = 0; b < unit_size; b++)
                            {
                                ...
                                {
                                    if (p_board->p_cols[i][b]->candidates[n] == 1 && n == c && p_board->p_rows[i][b]->candidates[n] >= 2)
                                    {
                            ...
                            for (int e = 0; e < unit_size; e++)
                            {
                                ...
                                {
                                    if (p_board->p_boxes[i][e]->candidates[r] == 1 && r == c && p_board->p_rows[i][e]->candidates[r] >= 2)
                                    {
